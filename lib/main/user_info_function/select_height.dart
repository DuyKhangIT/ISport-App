...
class SelectHeightScreen extends StatefulWidget {
  ...
  const SelectHeightScreen({Key? key, this.dataDeviceUser}) : super(key: key);
    ...
    if (updateDeviceInfoResponse.code != 0) {
      setState(() {
        ...
        Fluttertoast.showToast(
            msg: "Cập nhật chiều cao không thành công!",
      ...
      setState(() {
        ...
        if (isLoading) {
          ...
          Navigator.of(context).pop();
          Fluttertoast.showToast(
              msg: "Cập nhật chiều cao thành công",
              toastLength: Toast.LENGTH_SHORT,
              gravity: ToastGravity.BOTTOM,
